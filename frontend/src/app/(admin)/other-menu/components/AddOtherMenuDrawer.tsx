...
const AddOtherMenuDrawer = ({ onAdd }: any) => {
  ...
  // api
  const [createOthertMenu, { isLoading }] = useCreateotherMenuMutation()
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-3">
            ...
            <div className="mb-3">
              ...
              <input type="number" className="form-control" placeholder="" name="price" value={formData.price} onChange={handleChange} />
            </div>
          </div>
...
export default AddOtherMenuDrawer
