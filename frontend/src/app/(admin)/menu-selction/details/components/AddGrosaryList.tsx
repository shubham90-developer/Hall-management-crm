...
const AddGrosaryList = () => {
  ...
  return (
    <>
      {/* Open Button */}
      <button
        className="btn btn-info text-center rounded-pill px-4 d-flex align-items-center justify-content-center gap-2"
      ...
      <div
        ...
        <div
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <h4 className="fw-bold mb-1 text-white">🍽️ Grosary Management</h4>
                ...
                <div className="d-flex align-items-center justify-content-between gap-3">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted small mb-0">Grosary Item</p>
                    </div>
                  </div>
        ...
        <div className="border-top bg-white p-3">
          <div className="d-flex gap-2">
            ...
            <Link href={'/bookings/grosary/1'} className="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2">
