...
const AddGrosaryDrawer = ({ onAdd }: any) => {
  ...
  // api
  const [createGrosary, { isLoading }] = useCreateGrosaryMutation()
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    try {
      await createGrosary(formData as any).unwrap()
      toast.success('Grosary added successfully')
      setOpen(false)
      setFormData({
        grosaryName: '',
        status: 'Active',
    ...
    <>
      ...
      <div
        ...
        <div className="p-3 border-bottom bg-light d-flex justify-content-between align-items-center">
          <h5 className="mb-0 fw-bold"> Add Grocery </h5>
...
export default AddGrosaryDrawer
