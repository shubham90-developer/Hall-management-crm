...
import { useCreateMenuCategoryMutation } from '@/store/menuCategoryApi'
...
const AddMenuDrawer = ({ onAdd }: any) => {
  ...
  // api
  const [createMenuCategory, { isLoading }] = useCreateMenuCategoryMutation()
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    try {
      await createMenuCategory(formData as any).unwrap()
    ...
    <>
      ...
      <div
        ...
        <div className="p-3 border-bottom bg-light d-flex justify-content-between align-items-center">
          <h5 className="mb-0 fw-bold"> Add Menu Category</h5>
