...
import { useCreateBuffetNameMutation } from '@/store/buffetNameApi'

const AddBuffetDrawer = ({ onAdd }: any) => {
  ...
  // api
  const [createBuffetName, { isLoading }] = useCreateBuffetNameMutation()
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    try {
      await createBuffetName(formData as any).unwrap()
      toast.success('Buffet Name added successfully')
      setOpen(false)
      setFormData({
        buffetName: '',
        status: 'Active',
    ...
    <>
      ...
      <div
        ...
        <div className="p-3 border-bottom bg-light d-flex justify-content-between align-items-center">
          <h5 className="mb-0 fw-bold"> Add Buffet Name</h5>
...
export default AddBuffetDrawer
